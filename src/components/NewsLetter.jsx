...
const Newsletter = () => {
  return (
    <div className="container mx-auto rounded-lg my-8 px-4 py-12 md:py-16 lg:py-20 bg-blue-50 dark:bg-gray-900">
      ...
      <div className="mt-8 max-w-2xl mx-auto">
        <div className="card bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 md:p-8">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            ...
            />
            <button className="btn btn-primary flex items-center gap-2 px-6 py-3 rounded-xl hover:bg-blue-700 transition-all">
