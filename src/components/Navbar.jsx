...
const Navbar = () => {
  ...
  return (
    <div className='navbar sticky top-0 z-50 font-semibold bg-gradient-to-tr from-slate-950 to-rose-950 text-white rounded-b-lg shadow-sm container px-4 mx-auto'>
