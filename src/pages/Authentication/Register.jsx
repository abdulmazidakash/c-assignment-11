...
const Registration = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-306px)] my-12 border-2 container mx-auto rounded-lg border-gray-100 dark:bg-gray-800 dark:border-gray-600">
      <Helmet>
      ...
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white dark:bg-gray-800 rounded-lg lg:max-w-4xl">
        ...
        <div className="hidden mt-24 bg-cover bg-center lg:block lg:w-1/2 justify-center items-center">
